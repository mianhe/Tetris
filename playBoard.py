...
# draw the coming block in the rect of the next block board
    ...
    #draw the coming block in the rect, Top allign with the top horizontal line, one cell next to the right vertical line
    ...
    # def drawSettledBlock(self,grid as Grid):
